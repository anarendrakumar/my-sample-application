...
import { JobDeleteDialogComponent } from 'app/entities/MySampleApplication/job/job-delete-dialog.component';
import { JobService } from 'app/entities/MySampleApplication/job/job.service';
