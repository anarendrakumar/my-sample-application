...
import { MySampleApplicationSharedModule } from 'app/shared';
import {
  DepartmentComponent,
...
@NgModule({
  imports: [MySampleApplicationSharedModule, RouterModule.forChild(ENTITY_STATES)],
  declarations: [
    DepartmentComponent,
    DepartmentDetailComponent,
    DepartmentUpdateComponent,
...
export class MySampleApplicationDepartmentModule {}
